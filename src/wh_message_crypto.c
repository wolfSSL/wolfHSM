...
/* Swap the host-order chaining words of a serialized SHA-2 state. wordSize is
 * 4 (SHA-224/256) or 8 (SHA-384/512); any other value, including 0 for a
 * finalized digest, copies the array verbatim. */
