...
int wh_TransportNsc_ClientInit(void* context, const void* config,
...
int wh_TransportNsc_ClientSend(void* context, uint16_t size, const void* data)
{
    whTransportNscClientContext* ctx = (whTransportNscClientContext*)context;
    uint32_t rspSz;
    int      rc;
...
int wh_TransportNsc_ClientRecv(void* context, uint16_t* out_size, void* data)
{
    whTransportNscClientContext* ctx = (whTransportNscClientContext*)context;
...
int wh_TransportNsc_ClientCleanup(void* context)
{
    whTransportNscClientContext* ctx = (whTransportNscClientContext*)context;
    if (ctx == NULL) {
        return WH_ERROR_BADARGS;
...
int wh_TransportNsc_ServerInit(void* context, const void* config,
                               whCommSetConnectedCb connectcb,
                               void*                connectcb_arg)
{
...
int wh_TransportNsc_ServerRecv(void* context, uint16_t* inout_size, void* data)
{
    whTransportNscServerContext* ctx = (whTransportNscServerContext*)context;
...
int wh_TransportNsc_ServerSend(void* context, uint16_t size, const void* data)
{
...
int wh_TransportNsc_ServerCleanup(void* context)
{
    whTransportNscServerContext* ctx = (whTransportNscServerContext*)context;
    if (ctx == NULL) {
        return WH_ERROR_BADARGS;
