...
#
# All lifetimes are deliberately ~30 years: wolfSSL enforces the attribute
# certificate validity period, so a short-lived vector breaks the tests once
# it expires.
