...
#ifdef WOLFHSM_CFG_ENABLE_CLIENT
static int _testClientCounter(whClientContext* client)
{
...
static int _testNonExportableNvmAccess(whClientContext* client)
{
    ...
    WOLFHSM_CFG_PRINTF("Testing non-exportable NVM object access protection...\n");
    ...
    WOLFHSM_CFG_PRINTF("Non-exportable NVM object read correctly denied\n");
    ...
    WOLFHSM_CFG_PRINTF("Exportable NVM object read succeeded\n");
    ...
    WOLFHSM_CFG_PRINTF("Testing DMA NVM read protection...\n");
    ...
    WOLFHSM_CFG_PRINTF("Non-exportable NVM object DMA read correctly denied\n");
    ...
    WOLFHSM_CFG_PRINTF("Exportable NVM object DMA read succeeded\n");
    ...
    WOLFHSM_CFG_PRINTF("NON-EXPORTABLE NVM ACCESS TEST SUCCESS\n");
    return 0;
}
...
int whTest_ClientServerSequential(whTestNvmBackendType nvmType)
{
    ...
    WH_TEST_RETURN_ON_FAIL(wh_Client_CommInfoResponse(client,
            ...
            &lifecycle_state,
            &nvm_state));
    WOLFHSM_CFG_PRINTF("Server Info: \n - Version:%s\n - Build:%s\n", version, build);
    WOLFHSM_CFG_PRINTF(" - cfg_comm_data_len:%u\n", (unsigned int)cfg_comm_data_len);
    WOLFHSM_CFG_PRINTF(" - cfg_nvm_object_count:%u\n", (unsigned int)cfg_nvm_object_count);
    WOLFHSM_CFG_PRINTF(" - cfg_server_keycache_count:%u\n",
           (unsigned int)cfg_server_keycache_count);
    WOLFHSM_CFG_PRINTF(" - cfg_server_keycache_bufsize:%u\n",
           (unsigned int)cfg_server_keycache_bufsize);
    WOLFHSM_CFG_PRINTF(" - cfg_server_keycache_bigcount:%u\n",
           (unsigned int)cfg_server_keycache_bigcount);
    WOLFHSM_CFG_PRINTF(" - cfg_server_keycache_bigbufsize:%u\n",
           (unsigned int)cfg_server_keycache_bigbufsize);
    WOLFHSM_CFG_PRINTF(" - cfg_server_customcb_count:%u\n",
           (unsigned int)cfg_server_customcb_count);
    WOLFHSM_CFG_PRINTF(" - cfg_server_dmaaddr_count:%u\n",
           (unsigned int)cfg_server_dmaaddr_count);
    WOLFHSM_CFG_PRINTF(" - debug_state:%u\n", (unsigned int)debug_state);
    WOLFHSM_CFG_PRINTF(" - boot_state:%u\n", (unsigned int)boot_state);
    WOLFHSM_CFG_PRINTF(" - lifecycle_state:%u\n", (unsigned int)lifecycle_state);
    WOLFHSM_CFG_PRINTF(" - nvm_state:%u\n", (unsigned int)nvm_state);
...
#if defined(WOLFHSM_CFG_TEST_VERBOSE)
        WOLFHSM_CFG_PRINTF("Server HandleRequestMessage:%d\n", ret);
#endif
...
int whTest_ClientServerClientConfig(whClientConfig* clientCfg)
{
    ...
    /* Test attribute certificate API */
    WH_TEST_RETURN_ON_FAIL(whTest_CertClientAcert(client));
...
#if defined(WOLFHSM_CFG_CERTIFICATE_MANAGER_ACERT)
    /* Test attribute certificate API using DMA messages */
    WH_TEST_RETURN_ON_FAIL(
        whTest_CertClientAcertDma_ClientServerTestInternal(client));
#endif /* WOLFHSM_CFG_CERTIFICATE_MANAGER_ACERT */
