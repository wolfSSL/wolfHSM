...
int whTest_SheClientConfig(whClientConfig* config)
{
...
#ifdef WOLFHSM_CFG_TEST_VERBOSE
    {
        ...
        WOLFHSM_CFG_PRINTF("PRE-SHE TEST: NvmGetAvailable:%d, server_rc:%d avail_size:%d "
    ...
    WOLFHSM_CFG_PRINTF("SHE secure boot SUCCESS\n");
    ...
    WOLFHSM_CFG_PRINTF("SHE wh_SheGenerateLoadableKey SUCCESS\n");
    ...
    WOLFHSM_CFG_PRINTF("SHE LOAD KEY SUCCESS\n");
    ...
    WOLFHSM_CFG_PRINTF("SHE RND SUCCESS\n");
    ...
    WOLFHSM_CFG_PRINTF("SHE ECB SUCCESS\n");
    ...
    WOLFHSM_CFG_PRINTF("SHE CBC SUCCESS\n");
    ...
    WOLFHSM_CFG_PRINTF("SHE CMAC SUCCESS\n");
...
#ifdef WOLFHSM_CFG_TEST_VERBOSE
    {
        ...
        WOLFHSM_CFG_PRINTF("POST-SHE TEST: NvmGetAvailable:%d, server_rc:%d avail_size:%d "
               "avail_objects:%d, reclaim_size:%d reclaim_objects:%d\n",
               ret, (int)server_rc, (int)avail_size, (int)avail_objects,
               (int)reclaim_size, (int)reclaim_objects);
    }
...
int whTest_She(void)
{
    WOLFHSM_CFG_PRINTF("Testing SHE: (pthread) mem...\n");
