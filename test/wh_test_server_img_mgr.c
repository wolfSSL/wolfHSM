...
static int whTest_ServerImgMgrServerCfgEcc256(whServerConfig* serverCfg)
{
    ...
    WOLFHSM_CFG_PRINTF("IMG_MGR ECC P256 Test completed successfully!\n");
    return 0;
}
#endif /* HAVE_ECC */
...
static int whTest_ServerImgMgrServerCfgAes128Cmac(whServerConfig* serverCfg)
{
    ...
    WOLFHSM_CFG_PRINTF("IMG_MGR AES128 CMAC Test completed successfully!\n");
    return 0;
}
#endif /* WOLFSSL_CMAC */
...
static int whTest_ServerImgMgrServerCfgRsa2048(whServerConfig* serverCfg)
{
    ...
    WOLFHSM_CFG_PRINTF("IMG_MGR RSA2048 Test completed successfully!\n");
    return 0;
}
#endif /* !NO_RSA */
